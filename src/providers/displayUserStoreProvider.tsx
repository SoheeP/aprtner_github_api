...
import { createDisplayUserStore, type DisplayUserStore } from "@/stores/displayUser";
...
export const DisplayUserStoreContext = createContext<DisplayUserStoreApi | undefined>(
  undefined,
)
...
export const useDisplayUserStore = <T,>(
  ...
  if (!displayUserStoreContext) {
    throw new Error(`useCounterStore must be used within DisplayUserStoreProvider`)
  }
